...
This is the first decision layer for LocalSnow. It should be short enough to review before any UX, record mapping, SEO or engineering work begins.

## Company/product bet

LocalSnow will test whether a polished, trustworthy public discovery product can generate snowsports lesson demand through free self-managed inquiries and convert some high-intent demand into paid guaranteed bookings.

## One-line product

LocalSnow helps clients find credible snowsports professionals, send free self-managed inquiries, or pay online for a guaranteed booking where LocalSnow secures the lesson, a suitable trusted alternative, or a refund.

## Why now

Moli understands the mountain/instructor reality from inside the industry. The opportunity is not to build a giant marketplace first. The opportunity is to create a focused public acquisition surface and prove whether clients and professionals respond.

## Initial strategic posture

These are **approved Phase 1 directions with stated assumptions**, folded from Moli’s reviews:

1. **Revenue event:** guaranteed booking goes directly to low-friction online payment with the price calculated from the selected lesson/service. After payment, Moli can manually handle instructor confirmation, replacement, payout and any edge-case coordination behind the scenes. No Stripe Connect or automated instructor payout is required in the first scaffold.
...
1. Client looking for a ski/snowboard lesson in the first chosen launch market.
2. Independent instructor wanting credible public demand.
3. Light school/provider profile with simple directory/offers behavior and no staff/admin complexity.
4. Moli as owner-operator with full CRUD/control surfaces for requests, profiles, offers, payments, reviews and operational corrections.

## Business model thesis

The first revenue proof is guaranteed booking support: the client pays online because LocalSnow guarantees the lesson outcome, a suitable trusted alternative, or a refund.

The free self-managed path still matters. It generates leads, SEO traffic, trust, supply exposure and future monetizable attention even when LocalSnow does not guarantee the outcome.

V1 should not scatter across monetization options before demand exists, but it should support:

- free self-managed inquiry;
- paid guaranteed booking with online payment;
- simple owner-managed payout/settlement after fulfillment;
- future paid visibility, setup services, sponsorships or commissions only after demand evidence.

## V1 success criteria

Qualitative criteria:

- A client can understand the difference between free self-managed inquiry and paid guaranteed booking from mobile.
...
- Clients can leave reviews after a real lesson so profile trust compounds.

Proof targets to define before launch, not before this Phase 1 review:

- number of live credible profiles in first market;
- visitor → request conversion;
- self-managed inquiry vs guaranteed booking split;
- paid conversion for guaranteed bookings;
- successful manual fulfillment rate;
...
- Full marketplace.
- Instant booking.
- Fully automated replacement matching.
- Stripe Connect or full instructor payout system.
- Perfect real-time calendar truth.
- Complex packages/promos/pricing engine beyond the tight lesson/service price calculation needed for paid guaranteed bookings.
